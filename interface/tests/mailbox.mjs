...
const context = vm.createContext({paintView:(container, html)=>{container.innerHTML=html;},STATE:{mailbox:entries,projects:[],tasks:[{title:'TASK-MUST-NOT-APPEAR'}]},Mailbox:M,Library,...escape,window:{},staleBanner:()=>'',referenceLinks:()=>'',enhanceLibraryDiagrams:()=>{}});
